...
const Signup = ({ navigation }) => {
  ...
  const handleSignup = async () => {
    ...
    if (!trimmedEmail || !username || !firstName || !lastName || !password || !confirmPassword) {
    ...
    try {
      ...
      await Promise.all([
        AsyncStorage.setItem(`private_key_${trimmedEmail}`, privateKeyHex),
        AsyncStorage.setItem(`public_key_${trimmedEmail}`, publicKeyHex),
      ]);
      ...
      await Promise.all([
        AsyncStorage.removeItem(`private_key_${trimmedEmail}`),
        AsyncStorage.removeItem(`public_key_${trimmedEmail}`),
      ]);
